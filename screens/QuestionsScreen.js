...
/*   const GetModules = async () => {
      ...
      .then(function (response) { 
        //handle success
         ...
         //   console.log(item.id, index);
          ...
          //  console.log(ArrayLocal, "ids here");
          });
         que6.push(...result);
         setqu1(que6);
         setExcludedId(ArrayLocal);
       }) 
  ...
  function postresult() {
    ...
    console.log("SelectedAnsw",SelectedAnswers);
    var b = SelectedAnswers.slice(0, 6); // cinstant//  var b = SelectedAnswers.slice(0, 4);
   ...
   t=t.toString();
    ...
    //   console.log("a data",a1,a2,a3,a4);
  ...
  //  setData2(b);
    ...
    var bodyFormData = new FormData();
    bodyFormData.append("intList", t); // random ques ids
    bodyFormData.append("firstString", c); // random answers
    bodyFormData.append("secString", b); // base questions answers 
